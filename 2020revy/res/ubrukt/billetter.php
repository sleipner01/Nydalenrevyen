...
<html>
<head>
    <title>Billetter | Nydalenrevyen 2020</title>
...
<body>
    ...
    <div id="content">
        <div style="width: fit-content; margin: 30px auto; color: white; text-align: center;">
            <h1 style="font-weight: normal;">Billettene slippes snart!</h1> <br>
            <h3 style="font-weight: normal;">Følg oss på sosiale medier for å se hva vi holder på med!</h3>
        </div>
